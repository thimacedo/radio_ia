...
def menu():
    while True:
        ...
        print("========================================")
        print("1. [BOLETINS] Gerar Boletins Diários (TTS)")
        print("2. [JORNAL]   Gerar Locuções NJUD (Multi-speaker)")
        print("3. [GIRO]     Processar Giro nas Comarcas (Pipeline)")
        print("4. [RELATÓRIO] Enviar Relatório por E-mail")
        print("----------------------------------------")
        print("0. Sair")
        print("========================================")
